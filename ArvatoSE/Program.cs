...
namespace ArvatoSE
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            // FluentValidation
            builder.Services.AddValidatorsFromAssembly(Assembly.LoadFrom(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "ArvatoSE.Core.dll")));
